...
<form action="red.php" method="post"><button type="submit" class="btn  btn-success btn-lg" name="id" id="bur" value="'.$row["id"].'" >Редактировать</button></form>
<a data-toggle="modal" data-target="#Modal'.$row["id"].'" class="btn  btn-danger btn-lg"  >Удалить?</a>
